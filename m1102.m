...
%%
    ...
    fpcm=fopen('2016_11_24 11_02_53 2 6 32552.pcm', 'r');
    ...
    title(lg, 'Ћ„ћ  400 √ц - 7,5 к√ц. ЅќЋ№Ўќ… излуч.');
...
%     RECEIVED_SPECTRUM = abs(fft(RECEIVED_SIGNAL)); %1800:2400
    RECEIVED_SPECTRUM1 = abs(fft(RECEIVED_SIGNAL(32500:47000))); %1800:2400
    RECEIVED_SPECTRUM2 = abs(fft(RECEIVED_SIGNAL(58650:73150))); %1800:2400
