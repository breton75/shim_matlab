...
%% Ўумовой сигнал в диапазоне частот 1000 - 10000 √ц
%  0,5 - 0,5 - 1 сек.
% сигнал - повтор того же сигнала - пауза 1 сек.
% большой излучатель
...
%%
    ...
    lg = legend('Ўумовой сигнал в диапазоне частот 1000 - 10000 √ц');
    title(lg, '0,5 - 0,5 - 1 сек. в конце и начале обрезано 100 отсчетов. ЅќЋ№Ўќ… излуч.');
