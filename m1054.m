...
%% ћ≈јЌƒ– двупол€рный чередующийс€ (0 1 0 -1 0 1 0 -1)  со случайным интервалом
...
%%
    ...
    title(lg, 'ћ≈јЌƒ– двупол€рн. чередующийс€ со случ. интерв. ЅќЋ№Ўќ… излуч.');
...
%     RECEIVED_SPECTRUM = abs(fft(RECEIVED_SIGNAL)); %1800:2400
    RECEIVED_SPECTRUM1 = abs(fft(RECEIVED_SIGNAL(63000:75000))); %1800:2400
    RECEIVED_SPECTRUM2 = abs(fft(RECEIVED_SIGNAL(89000:101000))); %1800:2400
