...
%% ћ≈јЌƒ– однопол€рный со случайным интервалом
...
%%
    ...
    title(lg, 'ћ≈јЌƒ– однопол€рный со случайным интервалом. ЅќЋ№Ўќ… излуч.');
...
%     RECEIVED_SPECTRUM = abs(fft(RECEIVED_SIGNAL)); %1800:2400
    RECEIVED_SPECTRUM1 = abs(fft(RECEIVED_SIGNAL(35000:46000))); %1800:2400
    RECEIVED_SPECTRUM2 = abs(fft(RECEIVED_SIGNAL(61000:72000))); %1800:2400
