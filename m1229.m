...
%% ћ≈јЌƒ– двупол€рный чередующийс€ (0 1 0 -1 0 1 0 -1) с посто€нным интервалом
...
%%
    ...
    title(lg, 'ћ≈јЌƒ– двупол€рный чередующийс€ с посто€нным интервалом. ЅќЋ№Ўќ… излуч.');
...
%     RECEIVED_SPECTRUM = abs(fft(RECEIVED_SIGNAL)); %1800:2400
    RECEIVED_SPECTRUM1 = abs(fft(RECEIVED_SIGNAL(15000:26000))); %1800:2400
    RECEIVED_SPECTRUM2 = abs(fft(RECEIVED_SIGNAL(41000:52000))); %1800:2400
