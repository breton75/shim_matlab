...
%% »ћѕ”Ћ№— двупол€рный последовательный (1 -1 0 1 -1 0) со случайным интервалом
% ширина импульса 0,2 мс. ширина интервала случайно 0,2 - 2 мс. закон распределени€ - треугольник, со смещением вершины к минимальному значению
%  0,4 - 0,4 - 0,4 - 3 сек.
...
%%
    ...
    fpcm=fopen('2016_11_23 12_34_42 2 1 32552.pcm', 'r');
    ...
    title(lg, '»ћѕ”Ћ№— би-импульс со случайным интервалом. ЅќЋ№Ўќ… излуч.');
...
%     RECEIVED_SPECTRUM = abs(fft(RECEIVED_SIGNAL)); %1800:2400
    RECEIVED_SPECTRUM1 = abs(fft(RECEIVED_SIGNAL(65000:75000))); %1800:2400
    RECEIVED_SPECTRUM2 = abs(fft(RECEIVED_SIGNAL(91000:101000))); %1800:2400
