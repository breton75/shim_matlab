...
%% ћ≈јЌƒ– однопол€рный  с посто€нным интервалом
...
%%
    ...
    fpcm=fopen('2016_11_23 12_27_48 2 1 32552.pcm', 'r');
    ...
    title(lg, 'ћ≈јЌƒ– однопол€рный с посто€нным интервалом. ЅќЋ№Ўќ… излуч.');
