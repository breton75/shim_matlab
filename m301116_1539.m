...
%% МЕАНДР однополярный со случайным интервалом
% ширина импульса 20 мкс. ширина интервала случайно 0,1 - 1 мс. закон распределения треугольник, со смещением вершины к минимальному значению
%  0,4 - 0,1 - 0,4 - 1 сек.
